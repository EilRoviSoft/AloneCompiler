...
| ret   | 4 + `a0.size` | `0x03` | `ret a0`                      | `ax/gpx = a0; ipx = bpx; spx -= func_args.size + 8; bpx = [spx]` |
...
| pop  | 4                          | `Offset + 0x02` | `pop`            | `ax = [spx - pop.size]; spx -= pop.size` |
...
| cmp  | 20                         | `Offset + 0x05` | `cmp a0, a1`     | `a0 <=> a1`    | writes result to flags `ZF` and `SF` |
| neg  | 20                         | `Offset + 0x06` | `neg a0, a1`     | `a0 = -a1`     | only exists for signed types         |
| neg  | 12                         | `Offset + 0x06` | `neg a0`         | `a0 = -a0`     | only exists for signed types         |
